import { invokeAgent } from "@/lib/agents/technical-expert";
...
export async function POST(request: NextRequest) {
  try {
    console.log("[Agents API] Sending message to technical expert...");
    ...
    console.error(
      `[Agents API] Failed to send message to technical expert, error: ${getErrorString(error)}`,
    );
